...
Adafruit_SSD1306::Adafruit_SSD1306(uint8_t w, uint8_t h, TwoWire *twi,
  ...
  Adafruit_GFX(w, h), spi(NULL), wire(twi ? twi : &Wire), buffer(),
...
Adafruit_SSD1306::Adafruit_SSD1306(uint8_t w, uint8_t h,
  ...
  int8_t cs_pin) : Adafruit_GFX(w, h), spi(NULL), wire(NULL), buffer(),
...
Adafruit_SSD1306::Adafruit_SSD1306(uint8_t w, uint8_t h, SPIClass *spi,
  ...
  Adafruit_GFX(w, h), spi(spi ? spi : &SPI), wire(NULL), buffer(),
...
Adafruit_SSD1306::Adafruit_SSD1306(int8_t mosi_pin, int8_t sclk_pin,
  ...
  buffer(), mosiPin(mosi_pin), clkPin(sclk_pin), dcPin(dc_pin),
...
Adafruit_SSD1306::Adafruit_SSD1306(int8_t dc_pin, int8_t rst_pin,
  ...
  spi(&SPI), wire(NULL), buffer(), mosiPin(-1), clkPin(-1),
...
Adafruit_SSD1306::Adafruit_SSD1306(int8_t rst_pin) :
  ...
  buffer(), mosiPin(-1), clkPin(-1), dcPin(-1), csPin(-1),
  rstPin(rst_pin) {
}
